...
- [TCP의 연결 설정 과정(3단계)과 연결 종료 과정(4단계)이 단계가 차이나는 이유?](#7)
- [만약 Server에서 FIN 플래그를 전송하기 전에 전송한 패킷이 Routing 지연이나 패킷 유실로 인한 재전송 등으로 인해 FIN 패킷보다 늦게 도착하는 상황이 발생하면 어떻게 될까?](#8)
- [초기 Sequence Number인 ISN을 0부터 시작하지 않고 난수를 생성해서 설정하는 이유?](#9)
- [HTTP와 HTTPS에 대해서 설명하고 차이점에 대해 설명하세요.](#10)
- [HTTP 요청/응답 헤더의 구조를 설명해주세요.](#11)
- [HTTP와 HTTPS 동작 과정을 비교해주세요.](#12)
- [CORS란?](#13)
- [HTTP GET 메서드와 POST 메서드에 대해서 설명하세요.](#14)
- [쿠키(Cookie)와 세션(Session)을 설명해주세요.](#15)
- [DNS란?](#16)
- [REST와 RESTful의 개념을 설명해주세요.](#17)
- [소켓(Socket)이란?](#18)
- [Socket.io와 WebSocket의 차이를 설명해주세요.](#19)
- [IPv4 와 IPv6 차이를 설명해주세요.](#20)
- [MAC Address란?](#21)
- [라우터와 스위치, 허브의 차이는 뭔가요.](#22)
- [SMTP가 뭔가요?](#23)
- [당신이 노트북에서 `www.google.com`에 접속을 했습니다. 요청을 보내고 받기까지의 과정을 설명해주세요.](#24)
- [여러 네트워크 topology에 대해 소개해주세요 (간단히)](#25)
- [subnet mask에 대해서 설명해주세요.](#26)
- [data encapsulation이란?](#27)
- [DHCP이란?](#28)
- [routing protocol을 몇 가지 설명해주세요. (ex. link state, distance vector)](#29)
- [이더넷이란?](#30)
- [client와 server의 차이점?](#31)
...
#### HTTP와 HTTPS에 대해서 설명하고 차이점에 대해 설명하세요.
...
#### HTTP GET 메서드와 POST 메서드에 대해서 설명하세요.
