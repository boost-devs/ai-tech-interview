...
<!-- $m_t$ --> <img style="transform: translateY(0.1em); background: white;" src="../images/adc/deep-learning/lRWcjnUYPd.svg">와 <!-- $v_t$ --> <img style="transform: translateY(0.1em); background: white;" src="../images/adc/deep-learning/XLiIRJZ3mO.svg">의 식을 ∑ 형태로 펼친 후 양변에 expectation을 씌워서 정리해보면, 다음과 같은 보정을 통해 unbiased 된 expectation을 얻을 수 있다.
...
<!-- $v_t$ --> <img style="transform: translateY(0.1em); background: white;" src="../images/adc/deep-learning/m02mJokVad.svg">: time step t에서의 이동 벡터
<br>
...
<br>
이 때, <!-- $\gamma$ --> <img style="transform: translateY(0.1em); background: white;" src="../images/adc/deep-learning/c4HN5OEuby.svg">는 얼마나 momentum을 줄 것인지에 대한 momentum term이다.
